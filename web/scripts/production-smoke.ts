...
try {
  ...
  await mkdir('web/artifacts/production', { recursive: true });
  ...
  await page.screenshot({ path: 'web/artifacts/production/dashboard-desktop.png', fullPage: true });
  ...
  await expect
    ...
    .toBe(true);
  await page.screenshot({ path: 'web/artifacts/production/dashboard-mobile.png', fullPage: true });
  ...
  await page.screenshot({ path: 'web/artifacts/production/failure.png', fullPage: true });
...
await writeFile(
  'web/artifacts/production/verification.json',
  JSON.stringify(
    {
