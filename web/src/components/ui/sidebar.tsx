  ...
  return (
    <main
      className={cn(
        ...
        'md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ms-3 md:peer-data-[variant=inset]:m-3 md:peer-data-[variant=inset]:ms-0 md:peer-data-[variant=inset]:rounded-xl',
        className,
      )}
