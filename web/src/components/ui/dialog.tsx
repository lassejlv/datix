    ...
    <DialogPortal {...portalProps}>
      ...
      >
        <DialogPrimitive.Popup
          className={cn(
            'relative row-start-2 flex max-h-full min-h-0 w-full min-w-0 max-w-lg origin-center flex-col rounded-xl border border-hover bg-popover text-popover-foreground opacity-[calc(1-var(--nested-dialogs))] shadow-[0_24px_80px_#0005] outline-none transition-[scale,opacity,translate] duration-150 ease-[cubic-bezier(0.19,1,0.22,1)] motion-reduce:transition-none will-change-transform data-ending-style:opacity-0 data-starting-style:opacity-0 sm:scale-[calc(1-0.1*var(--nested-dialogs))] sm:data-ending-style:scale-98 sm:data-starting-style:scale-98',
            bottomStickOnMobile &&
...
export function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      className={cn('font-heading font-semibold text-xl leading-8 tracking-[-0.02em]', className)}
