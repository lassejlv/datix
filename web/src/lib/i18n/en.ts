export const en = {
  ...
  'One line before the closing head tag, on every page.':
    'One line before the closing head tag, on every page.',
  'Watch traffic arrive': 'Watch traffic arrive',
  ...
  'Account allowance': 'Account allowance',
  ...
  'Live counts across every account.': 'Live counts across every account.',
  'Load more': 'Load more',
  'Name, domain or owner email': 'Name, domain or owner email',
  'Name, email or account ID': 'Name, email or account ID',
  'No accounts match this filter.': 'No accounts match this filter.',
  'No administrative actions have been recorded yet.':
    'No administrative actions have been recorded yet.',
  'No websites match this filter.': 'No websites match this filter.',
  'None suspended': 'None suspended',
  Offline: 'Offline',
  'Open {name}': 'Open {name}',
  Owner: 'Owner',
  ...
  Platform: 'Platform',
  Reason: 'Reason',
  'Recorded in the audit log. 1–500 characters.': 'Recorded in the audit log. 1–500 characters.',
  Redis: 'Redis',
  ...
  Suspended: 'Suspended',
  'Suspension reason updated': 'Suspension reason updated',
  'Target {id}': 'Target {id}',
  'This account has no websites.': 'This account has no websites.',
  'This website has no environments.': 'This website has no environments.',
  Unverified: 'Unverified',
  Verified: 'Verified',
  'Website ID': 'Website ID',
  'Website restored': 'Website restored',
  'Website restored.': 'Website restored.',
  'Website suspended': 'Website suspended',
  'Website suspended.': 'Website suspended.',
  Yes: 'Yes',
  'by {actor}': 'by {actor}',
  environment: 'environment',
  ...
  website: 'website',
  websites: 'websites',
  '{count} environments': '{count} environments',
  '{count} not collecting': '{count} not collecting',
  '{count} sessions signed out': '{count} sessions signed out',
  '{count} suspended': '{count} suspended',
  '{date} · by {actor}': '{date} · by {actor}',
