...
export const de = {
  ...
  'I understand that I need a cookie banner and analytics consent.':
    'Ich verstehe, dass ich ein Cookie-Banner und eine Analyse-Einwilligung benötige.',
  'I understand that local storage requires analytics consent.':
    'Ich verstehe, dass lokale Speicherung eine Analyse-Einwilligung erfordert.',
  ...
  "No tracking identifiers or activity events are created before consent. Call this from your banner's analytics-consent callback, including its saved choice on every page. Pass false when consent is rejected or withdrawn.":
    'Vor der Einwilligung werden keine Tracking-Kennungen oder Aktivitätsereignisse erstellt. Rufe dies aus dem Analyse-Einwilligungs-Callback deines Banners auf, auch mit der gespeicherten Auswahl auf jeder Seite. Übergib false, wenn die Einwilligung abgelehnt oder widerrufen wird.',
