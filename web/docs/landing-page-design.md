...
Verified at 1440, 820, 390 and 320px in light and dark themes: layout without horizontal overflow, pricing navigation, all three plan previews, the Starter-only trial, Escape and keyboard focus restoration. Screenshots are `web/artifacts/landing/pricing-*.png`. Earlier Lighthouse scores below predate this addition.
...
Browser inspection verified the two poses in light and dark themes at desktop and mobile widths down to 320px, actual scroll displacement, no overflow, shared pause, and reduced motion. Screenshots are `web/artifacts/landing/mascots-*.png`.
...
Verified this experiment at desktop and mobile sizes in light and dark themes, including actual scroll displacement, pause/resume, reduced motion and no horizontal overflow. Screenshots are `web/artifacts/landing/particles-*.png`. The Lighthouse numbers below were captured before the particle experiment.
