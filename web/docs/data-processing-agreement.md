...
- TODO(confirm): applicable contract/DPA acceptance for the actual Railway, Neon, Upstash,
  Cloudflare and Sentry accounts and services. Railway's published DPA requires completion through
  its signing process and becomes binding upon Railway's execution; the public text alone is not
  evidence of an executed Article 28 agreement. Sentry's public DPA describes electronic
  acceptance/opt-in.
