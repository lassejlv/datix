...
export function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'relative w-(--sidebar-width) bg-transparent transition-[width] duration-200 motion-reduce:transition-none ease-linear',
      ...
      <div
        className={cn(
          'fixed inset-y-0 z-10 hidden h-dvh w-(--sidebar-width) transition-[left,right,width] duration-200 motion-reduce:transition-none ease-linear md:flex',
          side === 'left'
...
export function SidebarGroupLabel({
  ...
  const defaultProps = {
    className: cn(
      'flex h-8 shrink-0 items-center rounded-lg px-2 font-medium text-sidebar-foreground text-xs outline-hidden ring-sidebar-ring transition-[margin,opacity] duration-200 motion-reduce:transition-none ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
