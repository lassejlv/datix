...
try {
  ...
  await mkdir('artifacts/transitions', { recursive: true });
  ...
  await settled();
  await page.screenshot({ path: 'artifacts/transitions/desktop.png', fullPage: true });
  ...
  await page.screenshot({
    path: 'artifacts/transitions/mobile-reduced-motion.png',
    fullPage: true,
  });
  expect(errors).toEqual([]);
  await writeFile(
    'artifacts/transitions/verification.json',
    JSON.stringify(
      {
        base,
